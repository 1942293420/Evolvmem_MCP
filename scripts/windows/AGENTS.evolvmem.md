...
- When the user mentions a registered project and needs its background, call context_project_recall unless this turn already includes that project block from the hook. This reads project history without changing workspace binding or task focus.
